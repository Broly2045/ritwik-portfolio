  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Webhook Integration", level: 78 }
      ]
    },
    {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <div className="inline-block pixel-container bg-pixel-yellow/60 dark:bg-black/40 backdrop-blur-sm">
              <h3 className="font-pixel text-black dark:text-white mb-4">Also Proficient In</h3>
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  "Stripe API", "SendGrid API", "Groq API", "NextAuth.js",
                  "Vercel", "Render", "Vite", "Python", "C", "SQL",
                  "DSA", "Secure Coding", "AI Integration", "Claude Code"
                ].map((item, index) => (
                  <div 
                    key={index} 
